#!/bin/bash
#SBATCH --job-name=AI_paraphrase
#SBATCH --output=logs/ai_paraphrase_%j.out
#SBATCH --error=logs/ai_paraphrase_%j.err
#SBATCH --nodes=1
...
echo "========================================="
echo "Starting AI Text Paraphrasing"
...
# Run paraphrasing for AI texts
python scripts/run_paraphrasing.py \
    --input-csv data/ai_watermarked_text.csv \
    --output-csv data/paraphrased/ai_paraphrased.csv \
    --text-type ai \
...
echo "========================================="
echo "AI paraphrasing completed"
echo "End time: $(date)"
echo "========================================="
